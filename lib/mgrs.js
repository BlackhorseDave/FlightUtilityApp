...
function getMinNorthing(zoneLetter) {
 ...
 // Browser wrapper for the Flight Utility App.
 // The original MGRS library defines the conversion functions in this file.
 // This exposes them as window.mgrs so app.js can call:
 //   mgrs.forward([lon, lat], accuracy)
